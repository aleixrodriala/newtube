package com.github.vkay94.dtpv3.youtube.views
 ...
 *
 * Used by [YouTubeOverlay][com.github.vkay94.dtpv3.youtube.YouTubeOverlay].
 */
class SecondsView(context: Context, attrs: AttributeSet?) :
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.yt3_seconds_view, this, true)
