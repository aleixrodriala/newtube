...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    public static final long MENU_ITEM_DOWNLOAD = 1L << 39;
    ...
    public static final long MENU_ITEM_DEFAULT = MENU_ITEM_PIN_TO_SIDEBAR | MENU_ITEM_NOT_INTERESTED | MENU_ITEM_NOT_RECOMMEND_CHANNEL
            ...
            // NEWTUBE(mobile): YouTube puts "Save to Watch later" on every card menu. Existing
            // installs get it through the one-shot migration in MobileMainApplication.
            | MENU_ITEM_ADD_TO_WATCH_LATER
            // NEWTUBE(downloads): offered only while the phone installs a download handler.
            | MENU_ITEM_DOWNLOAD;
    private static final Long[] MENU_ITEM_DEFAULT_ORDER = {
            ...
            MENU_ITEM_RENAME_PLAYLIST, MENU_ITEM_ADD_TO_NEW_PLAYLIST, MENU_ITEM_DOWNLOAD, MENU_ITEM_NOT_INTERESTED, MENU_ITEM_NOT_RECOMMEND_CHANNEL, MENU_ITEM_BLOCK_CHANNEL,
